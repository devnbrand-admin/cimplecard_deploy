  ...
  const contactData = [
    {
      id: 1,
      title: "Stellar Email",
      icon: <MdEmail className="text-4xl text-teal-400" />,
      details: ["cosmic.con@galaxy.com", "info@stardustspace.com"],
      hoverBg: "hover:bg-teal-700",
    },
    {
      id: 2,
      title: "Celestial Phone",
      icon: <MdPhone className="text-4xl text-purple-400" />,
    ...
    },
    {
      id: 3,
      title: "Cosmic Birth",
      icon: <MdEvent className="text-4xl text-pink-400" />,
    ...
    },
    {
      ...
      icon: <MdLocationOn className="text-4xl text-blue-400" />,
      details: [
    ...
    <div className="w-full min-h-screen flex items-center justify-center bg-[#2b1923]">
      <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 p-8">
        {contactData.map((item) => (
          ...
          >
            <div className="p-4 rounded-full bg-gradient-to-r from-teal-700 to-black shadow-md">
              {item.icon}
            </div>
