  ...
  return (
    <div>
      <div className="fixed bottom-6 right-6 z-10">
        {!isInputOpen ? (
          <button
            className="p-4 rounded-full shadow-lg bg-[#121F2E]  text-[#CB935D] hover:scale-105 transform transition-transform flex items-center gap-2"
          ...
          <div className="bg-[#121F2E] p-4 rounded-lg shadow-md flex flex-col gap-4 border">
            <input
              type="tel"
              ...
              maxLength="10"  // Limit to prevent longer inputs
            />
            <div className="flex justify-between gap-2">
              <button
                className="bg-[#CB935D] text-white px-4 py-2 rounded-lg hover:scale-105 transition-transform"
                onClick={handleSend}
              >
                Send
              </button>
